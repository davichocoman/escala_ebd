...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentTab === 'scale') {
        ...
        renderLessons(); // Não carrega lições na inicialização se a aba de escala é a padrão
    }
    // Para garantir que ambos os dados estejam disponíveis, ou carregar ambos
    // Se a aba de lições for a padrão, você pode chamar loadLessonsData() aqui
});
